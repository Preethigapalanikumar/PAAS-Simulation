    ...
    <script>
        ...
        document.getElementById('loginBtn').addEventListener('click', function(e) {
            if (this.disabled) {
                ...
                // Here you would normally redirect to the dashboard with the selected tier
                alert(`Redirecting to your ${tierData[selectedTier].name} dashboard...`);
                // window.location.href = 'dashboard.php?tier=' + selectedTier;
                
                // For demo purposes, we'll just show a success message
                const instructionBanner = document.getElementById('instructionBanner');
                instructionBanner.textContent = `🎉 Welcome to your ${tierData[selectedTier].name}!`;
                instructionBanner.style.background = 'linear-gradient(135deg, #667eea, #764ba2)';
            }
        });
